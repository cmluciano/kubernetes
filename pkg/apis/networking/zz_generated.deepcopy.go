...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*NetworkPolicyCIDR).DeepCopyInto(out.(*NetworkPolicyCIDR))
			return nil
		}, InType: reflect.TypeOf(&NetworkPolicyCIDR{})},
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPolicyCIDR) DeepCopyInto(out *NetworkPolicyCIDR) {
	*out = *in
	if in.IP != nil {
		in, out := &in.IP, &out.IP
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, creating a new NetworkPolicyCIDR.
func (x *NetworkPolicyCIDR) DeepCopy() *NetworkPolicyCIDR {
	if x == nil {
		return nil
	}
	out := new(NetworkPolicyCIDR)
	x.DeepCopyInto(out)
	return out
}
	...
	if in.CIDRSelector != nil {
		...
		if *in == nil {
			...
			*out = new([]NetworkPolicyCIDR)
			if **in != nil {
				in, out := *in, *out
				*out = make([]NetworkPolicyCIDR, len(*in))
				for i := range *in {
					(*in)[i].DeepCopyInto(&(*out)[i])
				}
			}
